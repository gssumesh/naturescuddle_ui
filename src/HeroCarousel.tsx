...
export interface MailerFormProps extends HTMLAttributes<HTMLDivElement> {
  callback?: Function,
  dataAccount?: string,
  dataForm?: string 
}

export const MailerForm: FC<MailerFormProps> = ({
  children,
...rest
}) => {
    ...
    <div className="carousel">
      <div id="hero-carousel-slide1" className="relative carousel-item hero md:md:min-h-2/3 bg-nc-grey flex flex-col">
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <a href="#hero-carousel-slide4" className="invisible lg:visible btn btn-circle btn-sm">❮</a>
